...
public class WatchFaceDrawHelper {
    ...
    public WatchFaceDrawHelper(Resources resources, boolean isRound) {
        ...
        mTempYOffset = resources.getDimension(isRound? R.dimen.temp_y_offset_round : R.dimen.temp_y_offset);
        mWeatherIconYOffset = resources.getDimension(isRound? R.dimen.weather_icon_y_offset_round : R.dimen.weather_icon_y_offset);
        ...
        float weatherTextSize = resources.getDimension(isRound
                ? R.dimen.temp_high_size_round : R.dimen.temp_high_text_size);
        mHighestTempPaint.setTextSize(weatherTextSize);

        float weatherTextSize2 = resources.getDimension(isRound
                ? R.dimen.temp_low_size_round : R.dimen.temp_low_size);
